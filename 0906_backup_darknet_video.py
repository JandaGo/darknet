...
def parser():
    ...
    parser.add_argument("--input", type=str, default="./0323project/eee220224.avi",
    ...
    while cap.isOpened():
        ...
        if frame is not None:
            ...
            if label == "Person":
                ...
                pmy = int(y)
                pm = (pmx, pmy)
                rad_p = int(math.sqrt((int(w/2)*int(w/2))+(int(h/2)*int(h/2))))
            ...
            if label == "Forklift":
                ...
                fmy = int(y)
                fm = (fmx, fmy)
                rad_f = int(math.sqrt((int(w/2)*int(w/2))+(int(h/2)*int(h/2))))
            ...
            if label == "HandForklift":
                ...
                hmy = int(y)
                hm = (hmx, hmy)
                rad_h = int(math.sqrt((int(w/2)*int(w/2))+(int(h/2)*int(h/2))))

            
            # ###### hflf

            # if (pm != (None, None)) and (hm != (None, None)):
            #     point_dist_h = distance(pm, hm) - rad_p - rad_h
            #     # print(point_dist_h)
            ...
            if (pm != (None, None)) and (fm != (None, None)):
                point_dist_f = distance(pm, fm) - rad_f - rad_p
                # print(point_dist_f)
            ...
            if (pm != (None, None)) and (hm != (None, None)):
                point_dist_hf = distance(pm, hm) - rad_h - rad_p
                # print(point_dist_f)
                cv2.line(image, pm ,hm, (0, 255, 0), 1)
                # cv2.line(image, (pm, fm), (0, 255, 0), 1)
                if point_dist_hf < 50:

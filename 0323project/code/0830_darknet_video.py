...
def set_saved_video(input_video, output_video, size):
    ...
    video = cv2.VideoWriter(output_video, fourcc, 10, (416,416))
    return video
...
def drawing(frame_queue, detections_queue, fps_queue):
    ...
    while cap.isOpened():
        ...
        if frame is not None:
            ...
            # image = darknet.draw_boxes(detections_adjusted, frame_resized, class_colors)
            ...
            if (pm != (None, None)) and (hm != (None, None)):
                ...
                print(point_dist_h)
                print(int(po_dist) + 34 + int(ho_dist))
                if point_dist_h < int(po_dist) + 34 + int(ho_dist) :
                    # if point_dist_h > 0:
            ...
            if (pm != (None, None)) and (fm != (None, None)):
                ...
                if point_dist_f < int(po_dist) + 23 + int(fo_dist):
        ...
        #     point_dist_h = distance(pm, hm)
        #     print(point_dist_h)
        #     if point_dist_h < 200 and point_dist_h > 50:
        #         cv2.line(image, hm ,pm, (0, 255, 0), 1)
        #         cv2.putText(image, "hf_collision",
        #             (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1,
        #             (255, 0, 0), 2)    
        #         pm = None, None
